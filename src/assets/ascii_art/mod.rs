...
static ASCII_ART: &[(&'static str, Check, Option<&'static str>, &'static str, bool)] = &[
	...
	( "sabotage",			Check::StartsWith,	Some("Sabotage"),					include_str!("./large/s/.sabotage.clml"),			false,	),
	( "sabayon",			Check::StartsWith,	Some("Sabayon"),					include_str!("./large/s/.sabayon.clml"),			false,	),
	( "sailfish",			Check::StartsWith,	Some("Sailfish"),					include_str!("./large/s/.sailfish.clml"),			false,	),
	( "salentos",			Check::StartsWith,	Some("SalentOS"),					include_str!("./large/s/.salentos.clml"),			false,	),
	( "scientific",			Check::StartsWith,	Some("Scientific"),					include_str!("./large/s/.scientific.clml"),			false,	),
	( "septor",				Check::StartsWith,	Some("Septor"),						include_str!("./large/s/.septor.clml"),				false,	),
	( "serene",				Check::StartsWith,	Some("Serene"),						include_str!("./large/s/.serene.clml"),				false,	),
	( "sharklinux",			Check::StartsWith,	Some("SharkLinux"),					include_str!("./large/s/.sharklinux.clml"),			false,	),
	( "siduction",			Check::StartsWith,	Some("Siduction"),					include_str!("./large/s/.siduction.clml"),			false,	),
	( "slackware",			Check::StartsWith,	Some("Slackware"),					include_str!("./large/s/.slackware.clml"),			false,	),
	( "slackware_small",	Check::Is,			None,								include_str!("./small/s/.slackware.clml"),			false,	),
	( "slitaz",				Check::StartsWith,	Some("SliTaz"),						include_str!("./large/s/.slitaz.clml"),				false,	),
	( "smartos",			Check::StartsWith,	Some("SmartOS"),					include_str!("./large/s/.smartos.clml"),			false,	),
	( "solus",				Check::StartsWith,	Some("Solus"),						include_str!("./large/s/.solus.clml"),				false,	),
	( "sourcemage",			Check::StartsWith,	Some("Source Mage"),				include_str!("./large/s/.sourcemage.clml"),			false,	),
	( "",					Check::StartsWith,	Some("Source_Mage"),				"@sourcemage",										false,	),
	( "sparky",				Check::StartsWith,	Some("Sparky"),						include_str!("./large/s/.sparky.clml"),				false,	),
	( "star",				Check::StartsWith,	Some("Star"),						include_str!("./large/s/.star.clml"),				false,	),
	( "steamos",			Check::StartsWith,	Some("SteamOS"),					include_str!("./large/s/.steamos.clml"),			false,	),
	( "solaris",			Check::StartsWith,	Some("Solaris"),					include_str!("./large/s/.solaris.clml"),			false,	),
	( "sunos",				Check::StartsWith,	Some("SunOS"),						"@solaris",											false,	),
	...
	( "ubuntu_cinnamon",	Check::StartsWith,	Some("Ubuntu Cinnamon"),			include_str!("./large/u/.ubuntucinnamon.clml"),		false,	),
	( "",					Check::StartsWith,	Some("Ubuntu-Cinnamon"),			"@ubuntu_cinnamon",									false,	),
	( "ubuntu_budgie",		Check::StartsWith,	Some("Ubuntu Budgie"),				include_str!("./large/u/.ubuntubudgie.clml"),		false,	),
	( "",					Check::StartsWith,	Some("Ubuntu-Budgie"),				"@ubuntu_budgie",									false,	),
	( "ubuntu_gnome",		Check::StartsWith,	Some("Ubuntu GNOME"),				include_str!("./large/u/.ubuntugnome.clml"),		false,	),
	( "",					Check::StartsWith,	Some("Ubuntu-GNOME"),				"@ubuntu_gnome",									false,	),
	( "ubuntu_mate",		Check::StartsWith,	Some("Ubuntu MATE"),				include_str!("./large/u/.ubuntumate.clml"),			false,	),
	( "",					Check::StartsWith,	Some("Ubuntu-MATE"),				"@ubuntu_mate",										false,	),
	( "ubuntu_old",			Check::Is,			None,								include_str!("./old/u/.ubuntu.clml"),				false,	),
	( "ubuntu_studio",		Check::StartsWith,	Some("Ubuntu Studio"),				include_str!("./large/u/.ubuntustudio.clml"),		false,	),
	( "",					Check::StartsWith,	Some("Ubuntu-Studio"),				"@ubuntu_studio",									false,	),
